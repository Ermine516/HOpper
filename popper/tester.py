...
class Tester():
    ...
    def load_basic(self):
        ...
        ho_pl_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'ho.pl')

        for x in [ho_pl_path, exs_pl_path, bk_pl_path, test_pl_path]:
    ...
    def check_redundant_clause(self, program):
        # if the overhead of this call becomes too high, such as when learning programs with lots of clauses, we can improve it by not comparing already compared clauses
        prog = []
