...
def parse_args():
    ...
    parser.add_argument('--jump', type=float, default=0.0, help='Probability of generating a larger program')
    parser.add_argument('--jump-size', type=int, default=2, help='How much larger is a larger program')
    parser.add_argument('--main', type=str, default='f', help='Name of the main predicate to find')
